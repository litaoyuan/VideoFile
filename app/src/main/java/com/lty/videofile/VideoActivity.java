...
public class VideoActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == 0x123 && grantResults.length == 3
            ...
            textureView = new AutoFitTextureView(this, null);
            // 为TextureView组件设置监听器
    ...
    private void SetpMediaRecorder() {
        try {
            ...
            mNextVideoAbsolutePath = PathUtil.getFileStorePath(VideoActivity.this) + "/video_" + System.currentTimeMillis() + ".mp4";
            mMediaRecorder.setOutputFile(mNextVideoAbsolutePath);
            mMediaRecorder.setVideoEncodingBitRate(Integer.MAX_VALUE);
            mMediaRecorder.setVideoEncodingBitRate(10 * 1024 * 1920);
        ...
        try {
            ...
            cameraDeviceVideo.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession cameraCaptureSession) {
                    Toast.makeText(VideoActivity.this, "配置失败！", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            previewRequestBuilder = cameraDeviceVideo
